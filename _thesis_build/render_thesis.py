...
SRC = "/Users/m/Downloads/DreamCodeVRPlus/_deliverables/thesis.md"
CREST = os.path.join(HERE, "birmingham-crest.png")
OUT_HTML = os.path.join(HERE, "thesis.html")
RAW_PDF = os.path.join(HERE, "thesis_raw.pdf")
OUT_PDF = "/Users/m/Downloads/DreamCodeVR+_Dissertation_v3.pdf"
...
<div class="titlepage">
  ...
  <div class="meta">Word count: ~24,500 (main body, Chapters&nbsp;1&ndash;9)</div>
