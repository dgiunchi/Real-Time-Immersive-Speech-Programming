...
SRC = "/Users/m/Downloads/DreamCodeVRPlus/_deliverables/thesis_v5.md"
CREST = os.path.join(HERE, "birmingham-crest.png")
OUT_HTML = os.path.join(HERE, "thesis_v5.html")
RAW_PDF = os.path.join(HERE, "thesis_v5_raw.pdf")
OUT_PDF = "/Users/m/Downloads/DreamCodeVR+_Dissertation_v5.pdf"
