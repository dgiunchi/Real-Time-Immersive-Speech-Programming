...
/// An inbound control message the RoomServer understands. Types not yet
/// implemented (peer/room properties, blobs, discovery) are preserved as
/// [`ClientMessage::Other`] so they can be logged and ignored rather than
/// dropped as hard errors.
#[derive(Debug, Clone)]
