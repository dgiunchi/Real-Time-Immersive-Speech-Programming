...
namespace DreamCodeVR2.ExperimentalAuthoring
{
    ...
    [Serializable] public class AuthoringEnvelope { public string type; public AuthoringAction action; public PredefinedVoiceCommand command; public string command_id; public string action_id; public string reason; public string detail; [JsonProperty("reason_code")] public string reasonCode; [JsonProperty("participant_message")] public string participantMessage; [JsonProperty("primary_object_id")] public string primaryObjectId; [JsonProperty("secondary_object_id")] public string secondaryObjectId; [JsonProperty("primary_display_name")] public string primaryDisplayName; [JsonProperty("secondary_display_name")] public string secondaryDisplayName; [JsonProperty("resolution_stage")] public string resolutionStage; public ServerNextTaskDto task; public ServerQuestInstanceDto quest_instance; public string task_id; public string status; public bool confirmation_required; public string interpretation; public string expected_effect; public string target_object_id; [JsonProperty("original_utterance")] public string originalUtterance; [JsonProperty("recognized_utterance")] public string recognizedUtterance; public string utterance; public string transcript; public QuestConsequenceInstruction consequence; [JsonProperty("reset_request")] public QuestResetRequest resetRequest; [JsonProperty("protocol_version")] public int protocolVersion; [JsonProperty("instruction_id")] public string instructionId; [JsonProperty("reset_request_id")] public string resetRequestId; [JsonProperty("session_id")] public string sessionId; [JsonProperty("canonical_set_id")] public string canonicalSetId; [JsonProperty("source_task_id")] public string sourceTaskId; [JsonProperty("instruction_type")] public string instructionType; [JsonProperty("container_id")] public string containerId; [JsonProperty("lock_id")] public string lockId; public JObject payload; }
    [Serializable] public class QuestConsequenceInstruction { [JsonProperty("protocol_version")] public int protocolVersion; [JsonProperty("instruction_id")] public string instructionId; [JsonProperty("session_id")] public string sessionId; [JsonProperty("canonical_set_id")] public string canonicalSetId; [JsonProperty("source_task_id")] public string sourceTaskId; [JsonProperty("instruction_type")] public string instructionType; [JsonProperty("target_object_id")] public string targetObjectId; [JsonProperty("container_id")] public string containerId; [JsonProperty("lock_id")] public string lockId; public JObject payload; }
    [Serializable] public class QuestResetRequest { [JsonProperty("protocol_version")] public int protocolVersion; [JsonProperty("request_id")] public string requestId; [JsonProperty("reset_request_id")] public string resetRequestId; [JsonProperty("session_id")] public string sessionId; [JsonProperty("canonical_set_id")] public string canonicalSetId; public string RequestId=>string.IsNullOrWhiteSpace(resetRequestId)?requestId:resetRequestId; }
    ...
    public static class FixedQuestWireConverter
    {
        ...
        private static DreamCodeVR2.Quest.QuestRuntimeObjectSpec[] ConvertRuntimeObjects(ServerQuestInstanceDto setup,ServerNextTaskDto wire)
        {
            ...
            foreach(var value in values)DreamCodeVR2ClientLogger.Event("quest","REQUIRED_RUNTIME_OBJECT_RECEIVED",null,new { quest_instance_id=setup?.quest_instance_id,object_id=value.objectId,object_type=value.primitive,initial_anchor=value.initialAnchorId,sphere_profile=value.sphereProfile,source=value.source });return values.ToArray();
        }
